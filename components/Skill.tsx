  ...
  return (
    <div className='group relative flex cursor-pointer text-center'>
      <motion.img
        ...
        src={imageLink}
        alt={alt}
        className='rounded-full border border-gray-500 object-contain w-20 h-20 xl:w-28 xl:h-28 filter group-hover:grayscale transition duration-300 ease-in-out'
        title={ alt }
      />
