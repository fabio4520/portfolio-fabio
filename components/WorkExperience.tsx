...
export default function WorkExperience({}: Props) {
  return (
    <motion.div
      ...
      <div className='w-full flex space-x-5 overflow-x-scroll overflow-y-hidden p-10 snap-x snap-mandatory scrollbar scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#f7ab0a]/80'>
        <ExperienceCard/>
        <ExperienceCard/>
        <ExperienceCard/>
      </div>
